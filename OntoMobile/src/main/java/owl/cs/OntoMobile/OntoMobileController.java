...
public class OntoMobileController {
	...
	private static OWLOntology LoadOntology() throws OWLOntologyStorageException, FileNotFoundException  {
		return loadSave.LoadOntologyFile("C:\\Users\\ur13\\Documents\\Work\\FYP\\temp\\TempOnto.owl.xml");
	}
	...
	{	
		newOntology =  loadSave.LoadOntologyFile("C:\\Users\\ur13\\Documents\\Work\\FYP\\temp\\TempOnto.owl.xml");
	...
	public void AddDataProperty(@RequestParam("AcName") String AcName ,@RequestParam("Property") String Property, @RequestParam("Value") int value ) throws OWLOntologyStorageException, FileNotFoundException {
